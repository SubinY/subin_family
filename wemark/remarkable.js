...
!function (e) {
  ...
  var e;return function t(e, r, n) {
    function s(i, l) {
      ...
      function n() {
        this.ruler = new s();for (var e = 0; e < i.length; e++) {
      ...
      function n() {
        this.options = {}, this.ruler = new s();for (var e = 0; e < o.length; e++) {
      ...
      function n() {
        this.ruler = new o();for (var e = 0; e < a.length; e++) {
        ...
        var t,
            ...
            s = n.length,
            o = e.pos;if ((r = e.cacheGet(o)) > 0) return undefined;for (t = 0; s > t; t++) {
          if (n[t](e, true)) return undefined;
      ...
      t.exports = function (e, t, r, n) {
        var s,
          ...
          if (62 !== e.src.charCodeAt(g++)) {
            if (o) break;for (d = false, h = 0, f = p.length; f > h; h++) {
              if (p[h](e, s, r, true)) {
                d = true;break;
              }
        ...
        }return e.blkIndent = a, true;
      };
    }, {}], 22: [function (e, t, r) {
      "use strict";

      t.exports = function (e, t, r) {
        var n, s;if (e.tShift[t] - e.blkIndent < 4) return false;for (s = n = t + 1; r > n;) {
      ...
      function n(e, t) {
        ...
        var r,
          ...
          e.tokens[r].level === s && "paragraph_open" === e.tokens[r].type && (e.tokens[r + 2].tight = true, e.tokens[r].tight = true, r += 2);
        }
      ...
      t.exports = function (e, t, r, n) {
        var s,
            ...
            p = e.eMarks[t];if (u + 3 > p) return false;if (s = e.src.charCodeAt(u), 126 !== s && 96 !== s) return false;if (a = u, u = e.skipChars(u, s), o = u - a, 3 > o) return false;if (i = e.src.slice(u, p).trim(), i.indexOf("`") >= 0) return false;if (n) return true;for (l = t; (l++, !(l >= r)) && (u = a = e.bMarks[l] + e.tShift[l], p = e.eMarks[l], !(p > u && e.tShift[l] < e.blkIndent));) {
      ...
      t.exports = function (e, t, r, n) {
        var s,
            ...
            a = e.eMarks[t];if (l >= a) return false;if (s = e.src.charCodeAt(l), 35 !== s || l >= a) return false;for (o = 1, s = e.src.charCodeAt(++l); 35 === s && a > l && 6 >= o;) {
          o++, s = e.src.charCodeAt(++l);
        }return o > 6 || a > l && 32 !== s ? false : n ? true : (a = e.skipCharsBack(a, 32, l), i = e.skipCharsBack(a, 35, l), i > l && 32 === e.src.charCodeAt(i - 1) && (a = i), e.line = t + 1, e.tokens.push({ type: "heading_open", hLevel: o, lines: [t, e.line], level: e.level }), a > l && e.tokens.push({ type: "inline", content: e.src.slice(l, a).trim(), level: e.level + 1, lines: [t, e.line], children: [] }), e.tokens.push({ type: "heading_close", hLevel: o, level: e.level }), true);
      };
    }, {}], 27: [function (e, t, r) {
      "use strict";
      ...
      function n(e) {
        ...
        var a,
          ...
          u++;
        }return e.line = u, e.tokens.push({ type: "htmlblock", level: e.level, lines: [t, e.line], content: e.getLines(t, u, 0, true) }), true;
      };
      ...
      function n(e, t) {
        ...
        var l,
          ...
          for (E = false, C = 0, S = q.length; S > C; C++) {
            if (q[C](e, l, r, true)) {
              E = true;break;
            }
          }if (E) break;if (k) {
      ...
      t.exports = function (e, t) {
        var r,
          ...
          if (!(e.tShift[a] - e.blkIndent > 3)) {
            for (s = false, o = 0, i = l.length; i > o; o++) {
              if (l[o](e, a, r, true)) {
                s = true;break;
              }
            }if (s) break;
      ...
      function n(e, t) {
        ...
        }if (i = n(e, t).trim(), -1 === i.indexOf("|")) return false;if (u = i.replace(/^\||\|$/g, "").split("|"), p.length !== u.length) return false;if (s) return true;for (e.tokens.push({ type: "table_open", lines: f = [t, 0], level: e.level++ }), e.tokens.push({ type: "thead_open", lines: [t, t + 1], level: e.level++ }), e.tokens.push({ type: "tr_open", lines: [t, t + 1], level: e.level++ }), a = 0; a < u.length; a++) {
          e.tokens.push({ type: "th_open", align: p[a], lines: [t, t + 1], level: e.level++ }), e.tokens.push({ type: "inline", content: u[a].trim(), lines: [t, t + 1], level: e.level, children: [] }), e.tokens.push({ type: "th_close", level: --e.level });
        }for (e.tokens.push({ type: "tr_close", level: --e.level }), e.tokens.push({ type: "thead_close", level: --e.level }), e.tokens.push({ type: "tbody_open", lines: d = [t + 2, 0], level: e.level++ }), c = t + 2; r > c && !(e.tShift[c] < e.blkIndent) && (i = n(e, c).trim(), -1 !== i.indexOf("|")); c++) {
          for (u = i.replace(/^\||\|$/g, "").split("|"), e.tokens.push({ type: "tr_open", level: e.level++ }), a = 0; a < u.length; a++) {
            e.tokens.push({ type: "td_open", align: p[a], level: e.level++ }), e.tokens.push({ type: "inline", content: u[a].replace(/^\|? *| *\|?$/g, ""), level: e.level, children: [] }), e.tokens.push({ type: "td_close", level: --e.level });
      ...
      function n(e, t, r, n) {
        ...
        var t,
            ...
            s,
            o,
            i = e.tokens;if (!e.inlineMode) for (t = 1, r = i.length - 1; r > t; t++) {
          if ("paragraph_open" === i[t - 1].type && "inline" === i[t].type && "paragraph_close" === i[t + 1].type) {
            for (s = i[t].content; s.length && (o = n(s, e.inline, e.options, e.env), !(0 > o));) {
              s = s.slice(o).trim();
            }i[t].content = s, s.length || (i[t - 1].tight = true, i[t + 1].tight = true);
          }
        }
      };
      ...
      function n(e) {
        ...
        var t,
          ...
          if ("inline" === g[r].type) for (i = g[r].children, t = i.length - 1; t >= 0; t--) {
            if (l = i[t], "text" === l.type) {
              ...
              }c.length && (u < a.length && c.push({ type: "text", content: a.slice(u), level: p }), g[r].children = i = [].concat(i.slice(0, t), c, i.slice(t + 1)));
            }
          }
        }
      };
      ...
      function n(e) {
        ...
        var e = [],
            t = new i({ stripPrefix: false, url: true, email: true, twitter: false, replaceFn: function replaceFn(t, r) {
        ...
        var t,
            ...
            b,
            v = e.tokens,
            k = null;if (e.options.linkify) for (r = 0, i = v.length; i > r; r++) {
          if ("inline" === v[r].type) for (a = v[r].children, g = 0, t = a.length - 1; t >= 0; t--) {
            if (c = a[t], "link_close" !== c.type) {
              if ("htmltag" === c.type && (n(c.content) && g > 0 && g--, s(c.content) && g++), !(g > 0) && "text" === c.type && l.test(c.content)) {
                if (k || (k = o(), m = k.links, b = k.autolinker), u = c.content, m.length = 0, b.link(u), !m.length) continue;for (p = [], d = c.level, h = 0; h < m.length; h++) {
                ...
                }u.length && p.push({ type: "text", content: u, level: d }), v[r].children = a = [].concat(a.slice(0, t), p, a.slice(t + 1));
              }
      ...
      function n(e, t, r, n) {
        ...
        var t,
            ...
            s,
            o,
            i = e.tokens;if (e.env.references = e.env.references || {}, !e.inlineMode) for (t = 1, r = i.length - 1; r > t; t++) {
      ...
      function n(e) {
        ...
        var t, r, o, i, l;if (e.options.typographer) for (l = e.tokens.length - 1; l >= 0; l--) {
          if ("inline" === e.tokens[l].type) for (i = e.tokens[l].children, t = i.length - 1; t >= 0; t--) {
            r = i[t], "text" === r.type && (o = r.content, o = n(o), s.test(o) && (o = o.replace(/\+-/g, "±").replace(/\.{2,}/g, "…").replace(/([?!])…/g, "$1..").replace(/([?!]){4,}/g, "$1$1$1").replace(/,{2,}/g, ",").replace(/(^|[^-])---([^-]|$)/gm, "$1—$2").replace(/(^|\s)--(\s|$)/gm, "$1–$2").replace(/(^|[^-\s])--([^-\s]|$)/gm, "$1–$2")), r.content = o);
          }
        }
      };
    }, {}], 42: [function (e, t, r) {
      ...
      function n(e, t) {
        ...
        var t, r, l, c, u, p, h, f, d, g, m, b, v, k, _, y, x;if (e.options.typographer) for (x = [], _ = e.tokens.length - 1; _ >= 0; _--) {
          if ("inline" === e.tokens[_].type) for (y = e.tokens[_].children, x.length = 0, t = 0; t < y.length; t++) {
            if (r = y[t], "text" === r.type && !o.test(r.text)) {
              for (h = y[t].level, v = x.length - 1; v >= 0 && !(x[v].level <= h); v--) {}x.length = v + 1, l = r.content, u = 0, p = l.length;e: for (; p > u && (i.lastIndex = u, c = i.exec(l));) {
      ...
      t.exports = function (e, t) {
        var r,
            ...
            i,
            l = e.pos,
            a = e.src.charCodeAt(l);if (96 !== a) return false;for (r = l, l++, n = e.posMax; n > l && 96 === e.src.charCodeAt(l);) {
          l++;
      ...
      function n(e) {
        ...
        var r,
            ...
            a = true,
            c = e.posMax,
            u = e.src.charCodeAt(t);for (r = t > 0 ? e.src.charCodeAt(t - 1) : -1; c > i && e.src.charCodeAt(i) === u;) {
          i++;
        }return i >= c && (l = false), o = i - t, o >= 4 ? l = a = false : (s = c > i ? e.src.charCodeAt(i) : -1, (32 === s || 10 === s) && (l = false), (32 === r || 10 === r) && (a = false), 95 === u && (n(r) && (l = false), n(s) && (a = false))), { can_open: l, can_close: a, delims: o };
      }t.exports = function (e, t) {
        var r,
            n,
            o,
            ...
            u = e.posMax,
            p = e.pos,
            h = e.src.charCodeAt(p);if (95 !== h && 42 !== h) return false;if (t) return false;if (c = s(e, p), r = c.delims, !c.can_open) return e.pos += r, t || (e.pending += e.src.slice(p, e.pos)), true;if (e.level >= e.options.maxNesting) return false;for (e.pos = p + r, a = [r]; e.pos < u;) {
      ...
      t.exports = function (e, t) {
        var r,
          ...
          n++;
        }if (n !== a + 2) return e.pos += n - a, t || (e.pending += e.src.slice(a, n)), true;for (e.pos = a + 2, s = 1; e.pos + 1 < l;) {
      ...
      !function (t, s) {
        ...
        var e = function e(t) {
        ...
        };return e.prototype = { constructor: e, urls: true, email: true, twitter: true, newWindow: true, stripPrefix: true, truncate: undefined, className: "", htmlParser: undefined, matchParser: undefined, tagBuilder: undefined, link: function link(e) {
          ...
          var n = new e(r);return n.link(t);
            ...
            return this.text;
          } }), e.htmlParser.ElementNode = e.Util.extend(e.htmlParser.HtmlNode, { tagName: "", closing: false, getType: function getType() {
            return "element";
          }, getTagName: function getTagName() {
            return this.tagName;
            ...
            return "@" + this.twitterHandle;
          } }), e.match.Url = e.Util.extend(e.match.Match, { urlPrefixRegex: /^(https?:\/\/)?(www\.)?/i, protocolRelativeRegex: /^\/\//, protocolPrepended: false, getType: function getType() {
            return "url";
